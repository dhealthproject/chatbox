...
export function settings(): Settings {
  return {
    ...
    mcp: {
      servers: [{
        id: 'aidh-mcp',
        name: 'dhealth-intelligence',
        enabled: true,
        transport: {
          type: 'stdio',
          command: 'npx',
          args: ['dhealth_intelligence@latest'],
          env: {
            "MEM_PATH": "/Users/macbook/dhealth_intelligence/memories.json",
            "NEWSDATA_API_URL": "https://newsdata.io/api/1/latest",
            "NEWSDATA_API_KEY": "pub_79757758fb9ed3ed2e6d3ee05945c83d1969b",
            "IMAP_HOST": "imap.gmail.com",
            "IMAP_USER": "dh.intel.test@gmail.com",
            "IMAP_PASS": "lihe jeat eelr gaca",
            "IMAP_PORT": "993",
            "SMTP_SERVICE": "gmail",
            "SMTP_HOST": "smtp.gmail.com",
            "SMTP_PORT": "587",
            "SMTP_USER": "dh.intel.test@gmail.com",
            "SMTP_PASS": "lihe jeat eelr gaca"
          }
        }
      }],
