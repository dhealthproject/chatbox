...
import { ConnectorClient, useConnectorClient } from '@solana-commerce/kit';
        ...
        try {
            ...
            if (paymentMemo) {
                ...
                if (isSOL) {
                    ...
                    const lamports = BigInt(Math.floor(solAmountFloat * 1_000_000_000));

                    result = await transferWithMemo({
                        rpcUrl,
                        signer,
