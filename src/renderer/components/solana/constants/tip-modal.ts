...
import { WalletIcon, SolanaPayIcon } from '@solana-commerce/kit';
...
// Static Data — used by local helpers; iframe uses config.fixedAmounts when set
export const PRESET_AMOUNTS = [20] as const;
...
export const ALL_CURRENCIES = [
    { value: 'AIDH', label: 'dHealth Intelligence', symbol: 'AIDH' },
